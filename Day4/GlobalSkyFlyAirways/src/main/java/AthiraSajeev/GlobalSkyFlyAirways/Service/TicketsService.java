...
public class TicketsService {
    ...
    public List<Tickets> getTicketsByFlightId(String flightId) {
       return ticketsRepository.findTicketsByFlights(flightId);
    }
    ...
    public List<Tickets> getTicketByUserIdAndFlightId(String userId, String flightId) {
        return ticketsRepository.findTicketsByUserIdAndFlightId(userId,flightId);
    }


    public List<Tickets> getTicketByUserId(String userId) {
